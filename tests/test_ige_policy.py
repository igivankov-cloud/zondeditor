...
def test_build_ige_display_label_distinguishes_loams_by_consistency():
    assert build_ige_display_label("ИГЭ-1", label="ИГЭ-1", soil_name="суглинок", params={"consistency": "тугопластичная"}) == "ИГЭ-1 (суглинок, тугопластичная)"
    assert build_ige_display_label("ИГЭ-2", label="ИГЭ-2", soil_name="суглинок", params={"consistency": "мягкопластичная"}) == "ИГЭ-2 (суглинок, мягкопластичная)"


def test_build_ige_display_label_distinguishes_sands_by_kind():
    assert build_ige_display_label("ИГЭ-4", label="ИГЭ-4", soil_name="песок", params={"sand_kind": "средней крупности"}) == "ИГЭ-4 (песок, средней крупности)"
    assert build_ige_display_label("ИГЭ-5", label="ИГЭ-5", soil_name="песок", params={"sand_kind": "мелкий"}) == "ИГЭ-5 (песок, мелкий)"
...
def test_gravelly_sand_uses_descriptive_profile_and_is_not_calculable():
    ...
    assert build_ige_display_label("ИГЭ-7", label="ИГЭ-7", soil_name="песок гравелистый", params={"sand_kind": "гравелистый"}) == "ИГЭ-7 (песок гравелистый)"
